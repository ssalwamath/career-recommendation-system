...
Original file is located at
    https://colab.research.google.com/drive/1w4sYb0Dq8yqzDkTt37T4RXVKAKaLpAds
...
if st.button("🔍 Cari Pekerjaan yang Cocok"):
    ...
    cluster = predict_cluster(user_text)
    ...
    st.success(f"Cluster Kamu: {cluster}")
    ...
    st.write(f"""
    Berdasarkan teks yang kamu masukkan, sistem mendeteksi
    kecenderungan minat karier pada bidang **{cluster}**.
    """)